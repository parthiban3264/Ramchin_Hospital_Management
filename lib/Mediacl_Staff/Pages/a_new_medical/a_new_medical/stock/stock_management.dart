...
const Color primaryColorBlue = Color(0xFF854929);
...
class _StockPageState extends State<StockPage> {
  ...
  Future<void> fetchMedicines() async {
    ...
    try {
      ...
      final url = Uri.parse("$baseUrl/medicine-batch/$endpoint/$hospitalId");
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            child: const Text("Remove", style: TextStyle(color: primaryColor)),
          ),
        ],
      ),
    );
  ...
  Future<void> removeBatch(Map<String, dynamic> batch) async {
    try {
      await http.patch(
        Uri.parse("$baseUrl/medicine-batch/remove/$hospitalId"),
        headers: {"Content-Type": "application/json"},
        body: jsonEncode({
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Divider(color: primaryColor.withValues(alpha: 0.4)),

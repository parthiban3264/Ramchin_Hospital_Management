...
class SupplierReorderPdfPage extends StatefulWidget {
  ...
  @override
  State<SupplierReorderPdfPage> createState() => _SupplierReorderPdfPageState();
}
...
class _SupplierReorderPdfPageState extends State<SupplierReorderPdfPage> {
            ...
            pw.Container(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  ...[
                    textIfNotNull(
                      widget.supplier['phone']?.toString(),
                      "Phone",
                    ),
                    textIfNotNull(widget.supplier['email']?.toString(), "Mail"),
                    textIfNotNull(
                      widget.supplier['address']?.toString(),
                      "Address",
                    ),
                  ].whereType<pw.Widget>(),
                ],
            ...
            pw.Table(
              ...
              children: [
                pw.TableRow(
                  ...
                  children: [_th("Medicine"), _th("Required")],
                ),
  ...
  pw.Widget? textIfNotNull(String? value, String label) {
    ...
    return pw.Text("$label: $value", style: const pw.TextStyle(fontSize: 12));
  }
  ...
  pw.Widget _td(String t) =>
      pw.Padding(padding: const pw.EdgeInsets.all(6), child: pw.Text(t));

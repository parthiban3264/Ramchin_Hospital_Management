...
class ReorderPdfPage extends StatefulWidget {
  ...
  const ReorderPdfPage({super.key, required this.medicines});
              ...
              pw.Table(
                ...
                children: [
                  pw.TableRow(
                    ...
                    children: [_th("Medicine"), _th("Required Quantity")],
                  ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ListView.builder(
                        ...
                        physics:
                            const NeverScrollableScrollPhysics(), // single scroll

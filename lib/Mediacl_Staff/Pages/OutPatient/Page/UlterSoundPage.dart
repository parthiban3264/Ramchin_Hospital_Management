...
class UltersoundPage extends StatefulWidget {
  ...
  const UltersoundPage({Key? key, required this.record, required this.mode})
    : super(key: key);

  @override
  State<UltersoundPage> createState() => _UltersoundPageState();
}
...
class _UltersoundPageState extends State<UltersoundPage>
  ...
  void _handleSubmit() async {
    ...
    if (hasEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text("Please fill all UltraSound values."),
          backgroundColor: Colors.redAccent,
        ),
      );
      return;
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text('UltraSound marked as Completed ✅'),
  ...
  void handelSubmitReport() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text('UltraSound Report Submitted ✅'),
          backgroundColor: primaryColor,
        ),
      );
      Navigator.pop(context, true);
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('$e Error: failed to submit UltraSound Report'),
          backgroundColor: primaryColor,
        ),
      );
    } finally {
                      ...
                      children: [
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: "Enter UltraSound report or notes...",
  ...
  Widget _buildMedicalCard({
    ...
    // Collect selected UltraSound options
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Divider(height: 30, color: Colors.grey),
          _sectionHeader("Selected UltraSound Options"),
          const SizedBox(height: 10),

          if (selectedOptions.isEmpty)
            const Text(
              "No UltraSound Options Selected",

...
import '../Page/AbdomenScanPage.dart';

class AbdomenQueuePage extends StatefulWidget {
  const AbdomenQueuePage({super.key});

  @override
  State<AbdomenQueuePage> createState() => _AbdomenQueuePageState();
}

class _AbdomenQueuePageState extends State<AbdomenQueuePage> {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const Text(
              "No ABDOMEN patients in this tab",
        ...
        return GestureDetector(
          onTap: () async {
            final result = await Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => AbdomenPage(record: record, mode: mode),
              ),
            );
            if (result == true) {
              setState(() {
                futureXRayQueue = TestingScanningService()
                    .getAllTestingAndScanning('ABDOMEN');
              });
            }
          },
          child: Container(

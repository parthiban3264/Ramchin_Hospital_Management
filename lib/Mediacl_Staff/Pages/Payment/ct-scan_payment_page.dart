...
class CtScanFeesPaymentPage extends StatefulWidget {
  final Map<String, dynamic> fee;
  final Map<String, dynamic> patient;
  final int index;
  final String page;

  const CtScanFeesPaymentPage({
    super.key,
    required this.fee,
  ...
  @override
  State<CtScanFeesPaymentPage> createState() => CtScanFeesPaymentPageState();
}

class CtScanFeesPaymentPageState extends State<CtScanFeesPaymentPage> {

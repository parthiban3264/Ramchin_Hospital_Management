...
class CtScanFeesQueuePage extends StatefulWidget {
  const CtScanFeesQueuePage({super.key});

  @override
  State<CtScanFeesQueuePage> createState() => _CtScanFeesQueuePageState();
}

class _CtScanFeesQueuePageState extends State<CtScanFeesQueuePage> {
  ...
  void _loadFees() {
    _feesFuture = PaymentService().getAllOnlyCtScanPendingFees().then((list) {
      // Normalize status
                        ...
                        onTap: _currentIndex == 2
                            ...
                            : () async {
                                ...
                                final result = await Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (_) => CtScanFeesPaymentPage(
                                      fee: item,
                                      patient: patient,
                                      index: _currentIndex,
                                      page: 'queue',

...
class ReportCardWidget extends StatelessWidget {
  ...
  Future<Uint8List> _generatePdf(BuildContext context) async {
    ...
    photoBytes = await _loadImage(hospitalPhotoBase64);
            ...
            child: pw.Row(
              ...
              children: [
                pw.Column(
                  ...
                  children: [
                    pw.Text(
                      hospital['name'] ?? 'DRLOGY PATHOLOGY LAB',
                      style: pw.TextStyle(
                        color: primaryBlue,
